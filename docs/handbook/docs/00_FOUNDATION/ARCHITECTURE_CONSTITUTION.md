...
2. `pnpm lint` clean, `pnpm test` green (1200 tests as of 2026-07-31 — this number drifts with the codebase, re-run rather than trust it), E2E smoke test passes.
...
| `comfy_studio` | `LocalGenerationStudioPage` | Dedicated ComfyUI generation page — checkpoint picker, prompt/negative-prompt/width/height/steps/cfg/sampler/seed controls, Generate/Cancel, and result preview with gallery ingestion. Added 2026-07-29. |
