...
const NAVIGATION_COMMANDS: CommandItem[] = [
  ...
  { id: 'nav-converter', label: 'Converter', category: 'Navigation', keywords: ['convert', 'webp', 'avif', 'mp3', 'ffmpeg', 'transcode', 'format'], execute: () => appEventBus.emit('navigate', 'converter' as ActiveTab) },
  { id: 'nav-assets-manager', label: 'Assets Manager', category: 'Navigation', keywords: ['assets', 'bridge', 'browse', 'folders', 'files', 'manager', 'dam', 'catalog'], execute: () => appEventBus.emit('navigate', 'assets_manager' as ActiveTab) },
