...
const ArtistCard: React.FC<ArtistCardProps> = ({ item, onUpdateImages, onSelectItem, onInject }) => {
        ...
        <div className="p-8 flex flex-col justify-between flex-grow overflow-hidden">
            <div className="min-h-0">
                <div className="flex items-center gap-3 mb-2">
                    <span className="text-[9px] font-black uppercase tracking-[0.2em] text-primary/60">Creator ID</span>
            ...
            >
                <span className="text-[10px] font-black uppercase tracking-[0.2em] text-primary">Inject Artifact Token</span>
