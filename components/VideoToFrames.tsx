            ...
            <div className="flex-grow flex flex-col lg:flex-row overflow-hidden gap-6 p-0 bg-transparent">
                ...
                >
                    ...
                    <div className="flex flex-col h-full w-full overflow-hidden relative z-10 bg-base-100/40 backdrop-blur-xl">
                        ...
                        >
                            <button onClick={() => setActiveTab('extractor')} className={`btn btn-sm h-full rounded-none flex-1 font-normal text-2xs tracking-wider uppercase px-1 truncate btn-snake font-display ${activeTab === 'extractor' ? 'btn-ghost text-primary font-black no-glow' : 'btn-ghost text-base-content/60 hover:text-primary hover:no-glow'}`}>
                                <span/><span/><span/><span/>
                                FRAME EXTRACTOR
                            </button>
                            <button onClick={() => setActiveTab('joiner')} className={`btn btn-sm h-full rounded-none flex-1 font-normal text-2xs tracking-wider uppercase px-1 truncate btn-snake font-display ${activeTab === 'joiner' ? 'btn-ghost text-primary font-black no-glow' : 'btn-ghost text-base-content/60 hover:text-primary hover:no-glow'}`}>
                                <span/><span/><span/><span/>
                                VIDEO JOINER
                            </button>
                        </motion.div>
                        ...
                        >
                            {activeTab === 'extractor' ? (
                                <div className="space-y-6">
                                    <div>
                                        <label className="text-2xs font-black uppercase text-base-content/60 tracking-widest mb-4 block">Extraction Settings</label>
                                        <div className="form-control mb-4">
                                            <label className="label py-1"><span className="label-text text-2xs font-black uppercase text-base-content/60">Step Unit</span></label>
                                        ...
                                        <div className="form-control">
                                            <label className="label py-1"><span className="label-text text-2xs font-black uppercase text-base-content/60">Interval</span></label>
                                    ...
                                    <div>
                                        <label className="cursor-pointer label p-0 gap-4 mb-4">
                                            <span className="text-2xs font-black uppercase text-base-content/60 tracking-widest">Batch Job</span>
                                        ...
                                        {isBatchMode && (
                                            <div className="space-y-3">
                                                <div className="space-y-2">
                                                    <span className="text-2xs font-black uppercase text-base-content/60">Video Queue</span>
                                                ...
                                                <div className="space-y-1">
                                                    {batchVideoFiles.map((v, i) => (
                                                        <div key={v.id} className="flex items-center gap-3 group py-1.5 px-2 bg-base-100/10">
                                                            <span className="text-2xs font-mono text-base-content/60 w-5 shrink-0">{i + 1}</span>
                                                    ...
                                                    {batchVideoFiles.length === 0 && (
                                                        <div className="py-8 text-center opacity-60 uppercase font-black tracking-widest text-2xs">No videos queued</div>
                                                    )}
                                                </div>
                                            </div>
                                        )}
                                ...
                                <div className="space-y-8">
                                     <div>
                                        <label className="text-2xs font-black uppercase text-base-content/60 tracking-widest mb-4 block">Output Format</label>
                                         <div className="form-control mb-4">
                                            <label className="label py-1"><span className="label-text text-2xs font-black uppercase text-base-content/60">Container</span></label>
                                        ...
                                        <div className="form-control mb-4">
                                            <label className="cursor-pointer label p-0 gap-4 mb-3">
                                                <span className="text-2xs font-black uppercase text-base-content/60 tracking-widest">Keep Original Ratio</span>
                                                <input 
                                                    type="checkbox" 
                                    ...
                                    <div className="space-y-4">
                                        <div className="flex justify-between items-center">
                                            <label className="text-2xs font-black uppercase text-base-content/60 tracking-widest">Video Queue</label>
                                            <div className="flex gap-2">
                                        ...
                                        <div className="space-y-2">
                                            ...
                                            {joinFiles.length === 0 && (
                                                <div className="py-12 text-center opacity-60 uppercase font-black tracking-widest text-2xs">Awaiting sequence</div>
                                            )}
                                        </div>
                                    </div>
                                </div>
                    ...
                    >
                        ...
                        <div className="flex flex-col h-full w-full overflow-hidden relative z-10 bg-base-100/40 backdrop-blur-xl">
                            ...
                            >
                                ...
                                <span className="text-2xs font-mono font-bold text-base-content/60 uppercase">{frames.length} FILES</span>
                            </motion.header>
                            <motion.div 
                                variants={contentVariants}
                                custom={2.2}
                            ...
                            >
                                <div className={`grid ${isBatchMode ? 'grid-cols-3 lg:grid-cols-4' : 'grid-cols-2'} gap-px bg-transparent`}>
                                    ...
                                    {frames.length === 0 && (
                                        <div className="col-span-2 py-32 text-center opacity-60 uppercase font-black tracking-widest">Queue is Empty</div>
                                    )}
                                </div>
                            </motion.div>
                        </div>
