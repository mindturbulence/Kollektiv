        ...
        <div className="h-full bg-transparent flex flex-col overflow-hidden p-0">
            <div className="flex-grow flex flex-col lg:flex-row overflow-hidden">
                <aside className="w-full lg:w-96 flex-shrink-0 flex flex-col overflow-hidden bg-base-100/30 backdrop-blur-md">
                    ...
                    <footer className="p-4 bg-transparent flex flex-col gap-2">
                        {activeTab === 'extractor' ? (
                            <>
                ...
                <main className="flex-grow bg-transparent overflow-y-auto overflow-x-hidden scroll-smooth custom-scrollbar flex flex-col">
                    ...
                    {activeTab === 'extractor' ? (
                        <div className="flex-grow flex flex-col lg:flex-row overflow-hidden bg-transparent">
                            <div className="flex-1 flex flex-col p-8 lg:p-12 overflow-hidden bg-transparent">
                            ...
                            <div className="w-full lg:w-[480px] bg-transparent flex flex-col overflow-hidden">
                                <header className="p-6 bg-transparent flex justify-between items-center">
