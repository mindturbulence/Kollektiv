...
const McpSection: React.FC<McpSectionProps> = ({ activeSubTab, settings, handleSettingsChange }) => {
    ...
    return (
        <div className="flex flex-col animate-fade-in pb-12">
            <div className="px-6 py-4 border-b border-base-content/10 flex items-center justify-between">
                <div>
            ...
            {servers.length === 0 && (
                <div className="flex flex-col items-center justify-center py-20 gap-4">
                    ...
                    <p className="text-[10px] font-bold uppercase tracking-widest text-base-content/30">No MCP servers configured</p>
