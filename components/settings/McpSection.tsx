            ...
            <div className="px-6 py-4 border-b border-base-content/10">
                ...
                <div className="flex gap-0 mt-4">
                    <button
                        ...
                        className={`px-3 py-1 text-2xs font-black uppercase tracking-[0.3em] font-logo border border-base-300/30 ${tab === 'built-in' ? 'bg-primary/20 text-primary' : 'opacity-50 hover:opacity-100'}`}
                    >
                        Built-In
                    </button>
                    <button
                        onClick={() => { audioService.playClick(); setTab('custom'); }}
                        className={`px-3 py-1 text-2xs font-black uppercase tracking-[0.3em] font-logo border border-base-300/30 border-l-0 ${tab === 'custom' ? 'bg-primary/20 text-primary' : 'opacity-50 hover:opacity-100'}`}
                    >
            ...
            {tab === 'custom' && (
                <>
                    <div className="px-6 py-4 flex justify-end">
                        <button
                            onClick={addServer}
                            className="form-btn px-4 flex items-center gap-2 text-2xs font-black uppercase tracking-widest"
                        >
                                    ...
                                    <div className="flex items-center justify-between px-5 py-3 gap-4">
                                        ...
                                        <div className="flex items-center gap-1.5 flex-shrink-0">
                                            <button
                                                ...
                                                className={`form-btn px-3 text-2xs font-black uppercase tracking-widest ${isEditing ? 'text-primary' : ''}`}
                                            >
                                            ...
                                            <button
                                                ...
                                                className="form-btn px-3 text-2xs font-black uppercase tracking-widest text-error hover:bg-error/10"
                                            >
                                                Remove
                                            </button>
                                        </div>
                                            ...
                                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                                ...
                                                <div className="flex items-end">
                                                    <label className="label cursor-pointer justify-start gap-3 p-0">
                                                        ...
                                                        />
                                                        <span className="text-2xs font-black uppercase tracking-widest">Enable this server</span>
                                                    </label>
                                                </div>
                                            </div>
                                            ...
                                            <div className="flex flex-col gap-2">
                                                <div className="flex items-center justify-between">
                                                    ...
                                                    <button
                                                        ...
                                                        className="text-2xs font-black uppercase tracking-widest text-primary hover:text-primary-focus"
                                                    >
                                                        + Add Header
                                                    </button>
                                                </div>
                                                {sv.headers && Object.entries(sv.headers as Record<string,string>).map(([k, v], i) => (
                                                    <div key={i} className="flex items-center gap-2">
                                                        <input
                                                            ...
                                                            className="form-input flex-1 font-mono text-2xs"
                                                        ...
                                                        <input
                                                            ...
                                                            className="form-input flex-[2] font-mono text-2xs"
                                                            placeholder="Value"
                                                        />
                                                        <button
                                                            onClick={() => {
