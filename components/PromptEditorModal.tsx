          ...
          <div ref={bodyRef} className="p-10 space-y-8 flex-grow overflow-y-auto custom-scrollbar bg-transparent">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div className="form-control">
                  <label className="text-2xs font-black uppercase tracking-[0.2em] text-base-content/60 mb-2">Prompt Title</label>
                  <input
                    type="text"
                    value={title}
                ...
                <div className="form-control">
                  <label className="text-2xs font-black uppercase tracking-[0.2em] text-base-content/60 mb-2">Select Category</label>
                  <AutocompleteSelect 
                    value={categoryId} 
            ...
            <div className="form-control">
              <label className="text-2xs font-black uppercase tracking-[0.2em] text-base-content/60 mb-2">Prompt Text</label>
              <textarea
                ref={textAreaRef}
                value={text}
            ...
            <div className="form-control">
              <label className="text-2xs font-black uppercase tracking-[0.2em] text-base-content/60 mb-2">Metadata Tags</label>
