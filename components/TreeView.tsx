  ...
  return (
    <li>
      <button
        ...
        className={`w-full text-left p-2 text-2xs font-nunito transition-colors flex items-center justify-between ${isSelected ? 'text-primary no-glow' : 'text-base-content/70 hover:text-base-content'}`}
      >
