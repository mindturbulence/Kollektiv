...
function ModifierWeightSlider({
    ...
    return (
        <div className="flex items-center gap-3 mt-1 mb-2">
            ...
            />
            <span className="text-2xs font-mono font-bold text-primary w-12 text-right">{weight.toFixed(2)}</span>
        </div>
    );
}
...
export const RefinerModifierControls: React.FC<RefinerModifierControlsProps> = ({
    ...
    switch (activeRefineSubTab) {
                ...
                <div className="flex flex-col h-full space-y-6 overflow-hidden">
                    <div className="form-control flex-grow flex flex-col min-h-[120px]">
                        <div className="flex justify-between items-center mb-2">
                            <label className="text-2xs font-normal text-xs font-sf-mono uppercase tracking-widest text-base-content/60">Prompt Idea</label>
                    ...
                    <div className="form-control">
                        <label className="text-2xs font-normal text-xs font-sf-mono uppercase tracking-widest text-base-content/60 mb-2">Constant Modifiers</label>
                    ...
                    <div className="form-control">
                        <label className="text-2xs font-normal text-xs font-sf-mono uppercase tracking-widest text-base-content/60 mb-2">Media Output</label>
                    ...
                    <div className="grid grid-cols-2 gap-6">
                        <div className="form-control">
                            <label className="text-2xs font-normal text-xs font-sf-mono uppercase tracking-widest text-base-content/60 mb-2">Neural Engine</label>
                        ...
                        <div className="form-control">
                            <label className="text-2xs font-normal text-xs font-sf-mono uppercase tracking-widest text-base-content/60 mb-2">Complexity</label>
                    ...
                    <div className="form-control">
                        <div className="flex justify-between items-center mb-2">
                            <label className="text-2xs font-normal text-xs font-sf-mono uppercase tracking-widest text-base-content/60">Refiner Creativity / Uniqueness</label>
                            <span className="text-2xs font-mono font-bold text-primary">{modifiers.creativity ?? 70}%</span>
                        </div>
                        ...
                        <div className="flex justify-between px-1 mt-2">
                            <span className="text-2xs tracking-[0.3em] font-black opacity-20 uppercase">Accurate</span>
                            <span className="text-2xs tracking-[0.3em] font-black opacity-20 uppercase">Creative</span>
                        </div>
                    </div>
                </div>
            );
            ...
            return (
                <div className="flex flex-col gap-6">
                    <div className="grid grid-cols-1 gap-4">
                        <div className="form-control">
                            <label className="text-2xs font-black uppercase text-base-content/60 tracking-widest mb-2 block">Visual Discipline</label>
                        ...
                        <div className="form-control">
                            <label className="text-2xs font-black uppercase text-base-content/60 tracking-widest mb-2 block">Styling Trends</label>
                    ...
                    <div className="form-control">
                        <label className="text-2xs font-black uppercase text-base-content/60 tracking-widest mb-2 block">Aesthetics Look</label>
                    ...
                    <div className="form-control">
                        <label className="text-2xs font-black uppercase text-base-content/60 tracking-widest mb-2 block">Digital Trend</label>
                    ...
                    <div className="pt-4">
                        <label className="text-2xs font-black uppercase text-primary tracking-[0.3em] mb-4 block">Persona</label>
                        <div className="grid grid-cols-1 gap-4">
                            <div className="form-control">
                                <label className="text-2xs font-black uppercase text-base-content/60 tracking-widest mb-2 block">Facial Expressions</label>
                            ...
                            <div className="form-control">
                                <label className="text-2xs font-black uppercase text-base-content/60 tracking-widest mb-2 block">Hair Styles</label>
                            ...
                            <div className="grid grid-cols-1 gap-4">
                                <div className="form-control">
                                    <label className="text-2xs font-black uppercase text-base-content/60 tracking-widest mb-2 block">Eye Color</label>
                                ...
                                <div className="form-control">
                                    <label className="text-2xs font-black uppercase text-base-content/60 tracking-widest mb-2 block">Skin Texture</label>
                            ...
                            <div className="grid grid-cols-1 gap-4">
                                <div className="form-control">
                                    <label className="text-2xs font-black uppercase text-base-content/60 tracking-widest mb-2 block">Realism Options</label>
                                ...
                                <div className="form-control">
                                    <label className="text-2xs font-black uppercase text-base-content/60 tracking-widest mb-2 block">Clothing & Outfit</label>
        ...
        case 'photography':
            ...
            return (
                <div className="space-y-6 animate-fade-in">
                    <div className="form-control">
                        <label className="text-2xs font-black uppercase text-base-content/60 tracking-widest mb-2 block">Photo Genre</label>
                    ...
                    <div className="form-control">
                        <label className="text-2xs font-black uppercase text-base-content/60 tracking-widest mb-2 block">Aspect Ratio</label>
                    ...
                    <div className="form-control">
                        <label className="text-2xs font-black uppercase text-base-content/60 tracking-widest mb-2 block">Camera Body Type</label>
                    ...
                    <div className="grid grid-cols-1 gap-4">
                        <div className="form-control">
                            <label className="text-2xs font-black uppercase text-base-content/60 tracking-widest mb-2 block">Professional Camera Model</label>
                        ...
                        <div className="form-control">
                            <label className="text-2xs font-black uppercase text-base-content/60 tracking-widest mb-2 block">Film Stock</label>
                    ...
                    <div className="form-control">
                        <label className="text-2xs font-black uppercase text-base-content/60 tracking-widest mb-2 block">Specialty Optics</label>
                    ...
                    <div className="grid grid-cols-1 gap-4">
                        <div className="form-control">
                            <label className="text-2xs font-black uppercase text-base-content/60 tracking-widest mb-2 block">Lens Type</label>
                        ...
                        <div className="form-control">
                            <label className="text-2xs font-black uppercase text-base-content/60 tracking-widest mb-2 block">Shot Angle</label>
                    ...
                    <div className="grid grid-cols-1 gap-4">
                        <div className="form-control">
                            <label className="text-2xs font-black uppercase text-base-content/60 tracking-widest mb-2 block">Shot Proximity</label>
                        ...
                        <div className="form-control">
                            <label className="text-2xs font-black uppercase text-base-content/60 tracking-widest mb-2 block">Technical Settings</label>
                    ...
                    <div className="grid grid-cols-1 gap-4">
                        <div className="form-control">
                            <label className="text-2xs font-black uppercase text-base-content/60 tracking-widest mb-2 block">Camera Distortion</label>
                        ...
                        <div className="form-control">
                            <label className="text-2xs font-black uppercase text-base-content/60 tracking-widest mb-2 block">Lighting Rig</label>
                    ...
                    <div className="form-control">
                        <label className="text-2xs font-black uppercase text-base-content/60 tracking-widest mb-2 block">Composition Layout</label>
                    ...
                    <div className="grid grid-cols-1 gap-4">
                        <div className="form-control">
                            <label className="text-2xs font-black uppercase text-base-content/60 tracking-widest mb-2 block">Time of Day</label>
                        ...
                        <div className="form-control">
                            <label className="text-2xs font-black uppercase text-base-content/60 tracking-widest mb-2 block">Weather</label>
                        ...
                        <div className="form-control">
                            <label className="text-2xs font-black uppercase text-base-content/60 tracking-widest mb-2 block">Color Grade</label>
        ...
        case 'motion':
            return (
                <div className="space-y-6 animate-fade-in">
                    <label className="text-2xs font-black uppercase text-base-content/60 tracking-widest block">Generation Method</label>
                    <div className="form-tab-group">
                    ...
                    <div className="form-control">
                        <label className="text-2xs font-black uppercase text-base-content/60 tracking-widest mb-2 block">Motion</label>
                    ...
                    <div className="form-control">
                        <label className="text-2xs font-black uppercase text-base-content/60 tracking-widest mb-2 block">Pathing</label>
                    ...
                    <div className="form-control">
                        <label className="text-2xs font-black uppercase text-base-content/60 tracking-widest mb-2 block">Video Effects</label>
        ...
        case 'audio':
            return (
                <div className="grid grid-cols-1 gap-6 animate-fade-in">
                    <div className="form-control">
                        <label className="text-2xs font-black uppercase text-base-content/60 tracking-widest mb-2 block">Audio Category</label>
                    ...
                    <div className="form-control">
                        <label className="text-2xs font-black uppercase text-base-content/60 tracking-widest mb-2 block">Voice Profile</label>
                    ...
                    <div className="form-control">
                        <label className="text-2xs font-black uppercase text-base-content/60 tracking-widest mb-2 block">Voice Tone</label>
                    ...
                    <div className="form-control">
                        <div className="flex justify-between items-center mb-2">
                            <label className="text-2xs font-normal text-xs font-sf-mono uppercase tracking-widest">Targeted Duration</label>
                            <span className="text-2xs font-mono font-bold text-primary">{modifiers.audioDuration}s</span>
                        </div>
                    ...
                    <div className="form-control">
                        <label className="text-2xs font-black uppercase text-base-content/60 tracking-widest mb-2 block">Acoustic Environment</label>
                    ...
                    <div className="form-control">
                        <label className="text-2xs font-black uppercase text-base-content/60 tracking-widest mb-2 block">Audio Mood</label>
                    ...
                    <div className="form-control">
                        <label className="text-2xs font-black uppercase text-base-content/60 tracking-widest mb-2 block">Music Genre</label>
                    ...
                    <div className="form-control">
                        <label className="text-2xs font-black uppercase text-base-content/60 tracking-widest mb-2 block">Instrumentation</label>
                    ...
                    <div className="form-control">
                        <label className="text-2xs font-black uppercase text-base-content/60 tracking-widest mb-2 block">Vocal Style</label>
                    ...
                    <div className="form-control">
                        <label className="text-2xs font-black uppercase text-base-content/60 tracking-widest mb-2 block">Production Era</label>
                    ...
                    {isMidjourney ? (
                        <>
                            <div className="grid grid-cols-2 gap-4">
                                <div className="form-control">
                                    <label className="text-2xs font-black uppercase text-base-content/60 mb-2">Standard</label>
                                ...
                                <div className="form-control">
                                    <label className="text-2xs font-black uppercase text-base-content/60 mb-2">Niji (Anime)</label>
                            ...
                            <div className="form-control">
                                <label className="text-2xs font-black uppercase text-base-content/60 mb-2">Aspect Ratio (--ar)</label>
                            ...
                            <div className="space-y-6">
                                <div className="form-control">
                                    <div className="flex justify-between items-center mb-2">
                                        <label className="text-2xs font-black uppercase text-base-content/60 tracking-widest">Stylize (--s)</label>
                                        <span className="text-2xs font-mono font-bold text-primary">{modifiers.mjStylize}</span>
                                    </div>
                                ...
                                <div className="form-control">
                                    <div className="flex justify-between items-center mb-2">
                                        <label className="text-2xs font-black uppercase text-base-content/60 tracking-widest">Chaos (--c)</label>
                                        <span className="text-2xs font-mono font-bold text-primary">{modifiers.mjChaos}</span>
                                    </div>
                                ...
                                <div className="form-control">
                                    <div className="flex justify-between items-center mb-2">
                                        <label className="text-2xs font-black uppercase text-base-content/60 tracking-widest">Weird (--weird)</label>
                                        <span className="text-2xs font-mono font-bold text-primary">{modifiers.mjWeird}</span>
                                    </div>
                            ...
                            <div className="form-control">
                                <label className="text-2xs font-black uppercase text-base-content/60 mb-2">Negative Constraints (--no)</label>
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                <label className="label cursor-pointer justify-start gap-4">
                                    <span className="text-2xs font-black uppercase text-base-content/60">Seamless (--tile)</span>
                        ...
                        <>
                            <div className="space-y-4 h-full flex flex-col">
                                <label className="text-2xs font-black uppercase text-primary/60 tracking-[0.2em] block">Reference Materials</label>
