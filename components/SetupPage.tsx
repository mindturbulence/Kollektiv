...
export const SetupPage: React.FC<SetupPageProps> = ({
    ...
    const handleSettingsChange = useCallback((field: keyof LLMSettings, value: any) => {
        ...
        setSettings(updated);
        if (['youtube', 'googleIdentity', 'spotify', 'dashboardImageUrl', 'dashboardVideoUrl', 'darkTheme', 'mcpServers', 'googleApiKey', 'storageProvider', 'driveFolderId', 'driveFolderName', 'autoTagEnabled', 'providerFallbackEnabled', 'providerFallbackChain', 'embeddingModel', 'generationBackendId', 'comfyUrl', 'a1111Url', 'comfyModel', 'a1111Model', 'comfySampler', 'a1111Sampler', 'a1111AdditionalModules', 'modifierWeights', 'voiceSilenceTimeoutMs'].includes(field)) updateSettings(updated);
