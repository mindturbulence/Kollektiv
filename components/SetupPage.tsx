        ...
        <div className="fixed inset-0 bg-base-100 z-[500] flex flex-col items-center justify-center overflow-hidden select-none">
            ...
            <div className="relative z-10 flex flex-col items-center">
                <div className="overflow-hidden mb-6 px-4">
                    <h1 ref={textWrapperRef} className={`grid grid-cols-1 grid-rows-1 text-2xl md:text-4xl font-black tracking-tighter uppercase select-none items-center ${settings.darkTheme === 'pipboy' ? 'font-monofonto' : 'font-mono'}`}>
...
export const SetupPage: React.FC<SetupPageProps> = ({ 
  ...
  const handleMultipleSettingsChange = (updates: Partial<LLMSettings>) => {
        ...
        return (
            <div className="flex flex-col animate-fade-in">
                ...
                <SettingRow label="Background Type" desc="Choose the visual background for the application.">
                    ...
                    >
                        <option value="color">None (Theme Color)</option>
                ...
                {settings.dashboardBackgroundType === 'image' && (
                    <SettingRow label="Dashboard Image" desc="Select a static image background.">
                        ...
                        >
                            ...
                            <option value="/background-small.jpg">Small Background</option>
                        </select>
                    </SettingRow>
                )}
