...
const AboutModal: React.FC<AboutModalProps> = ({ isOpen, onClose }) => {
  ...
  const modalContent = (
    <div className="fixed inset-0 bg-black/40 backdrop-blur-xl z-[1000] flex items-center justify-center p-4 animate-fade-in" onClick={onClose} role="dialog" aria-modal="true">
      <div className="bg-base-100/40 rounded-none w-full max-w-2xl mx-auto overflow-hidden" onClick={(e) => e.stopPropagation()}>
