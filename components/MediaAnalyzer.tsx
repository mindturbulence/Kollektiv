...
export const MediaAnalyzer: React.FC<MediaAnalyzerProps> = ({ onSaveSuggestion, onSaveAsPreset, onRefine, onClip, header }) => {
    ...
    return (
        <div className="grid grid-cols-1 lg:grid-cols-12 overflow-hidden h-full gap-4 relative">
            ...
            {/* Media Input Area */}
            <aside className="lg:col-span-3 flex flex-col min-h-0 bg-base-100/30 backdrop-blur-md border-r border-base-300/20 relative z-10">
                {header}
            ...
            <main className="lg:col-span-9 flex flex-col min-h-0 bg-base-100/30 backdrop-blur-md relative z-10">
                ...
                <div ref={resultsScrollerRef} className="flex-grow overflow-y-auto no-scrollbar flex flex-col">
                    {error && (
                ...
                <CustomScrollbar containerRef={resultsScrollerRef} />
            </main>
        </div>
    );
};
